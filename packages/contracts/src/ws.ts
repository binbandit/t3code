...
import { RecheckProviderHealthInput, ServerConfigUpdatedPayload } from "./server";
...
export const WS_METHODS = {
  ...
  serverRecheckProviderHealth: "server.recheckProviderHealth",
} as const;
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.serverRecheckProviderHealth, RecheckProviderHealthInput),
]);
